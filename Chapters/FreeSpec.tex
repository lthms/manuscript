...
\begin{example}[Memory Controller Interfaces]
  ...
  The memory controller interface is similar, but it distinguishes between privileged and
  ...
  %
  The memory controller interface, denoted by $\I_{\mathrm{MCH}}$, is defined with three
  constructors:
  \begin{itemize}
  \item
