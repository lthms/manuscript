...
\paragraph{}
%
In Alloy, components' connections are modelled by aggregation.
%
...
%
Besides, BlueSpec is a target for Kami's models extraction.
%
...
% targeted security properties, our objective is to change the nature of proof
% of implementation correctness.
%%
% Rather than proving a given implementation enforce a security property, it
% should be shown that it complies to a verified HSE mechanism specification
% which targets this security property.
%
...
%%
% \item[--] Focus on x86 virtualisation technology features, with a simple
%   memory model.
...
%
% \begin{compactitem}
% \item[--] In the previous section, the hardware model are often very
%   simplified.
% \item[--] In the previous Chapter, we have explained in depth why such
...
% \item[--] Contrary to HSE mechanisms, the CPU alone implements a security
%   policy
...
% \end{compactitem}
%
% \section{Formal Verification of Inter-connected
% Components} % ==================
% \label{sec:relatedwork:modular}
%
% \begin{compactitem}
% \item[--] Regarding the scale of our self-assigned task, modular verification
%   is a ``must-have'' (probably use the wording of the FreeSpec for introducing
%   here)
% \end{compactitem}
%
...
%
% \begin{compactitem}
% \item[--] Compared to regular automata, interface automata produce a result
%   for each (labeled) transition
...
%
% \begin{compactitem}
% \item[--] This is reminiscent to the problematic language of large program
%   with effects
% \item[--] Alloy\,\cite{jackson2012alloy} is a very good example of what we
%   want to achieve
