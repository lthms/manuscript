...
\PC{il manque aussi l'argument de la difficulté à maintenir / faire évoluer le
	modèle si un composant change - or c'est le cas en pratique: de
	nombreuses archis sont similaires, mais avec quelques différences dans
les composants}
...
does not create\PC{make them vulnerable to} compositional attacks.
%
