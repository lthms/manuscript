...
\begin{definition}[Isolation Policy]
  ...
  A isolation policy $I$ is a safety property characterized by
...
\begin{example}[Software Stack Isolation]
  ...
  \begin{minipage}[c]{0.3\linewidth}
    \centering
    \begin{prooftree}
      \AxiomC{$x \in S$} \RightLabel{\scriptsize{$\rightarrowtail$-bios}}
...
mapping \func{context} (Definition~\ref{def:hardsoftmap}).
%
...
behavior is out of the scope of this article.
 ...
 \[
   \texttt{CacheLine}_{\set{S}} \triangleq
   \begin{array}{ll}
     \{\,dirty
     &:\setshortdef{\val{true},\,\val{false}} \\
     % ------------------------------------------------
