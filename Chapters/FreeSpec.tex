...
produce a value.
%
A component is characterized primarily by the \emph{interface} it exposes to the
rest of the system, and secondarily by the interfaces it uses in order to
operate.
%
...
\begin{figure}
  \begin{center}
    \begin{tikzpicture}
      ...
      % Cache
      \node [inner sep=8pt, draw, below=30pt of CPU.center] (Cache) {Cache};%
      ...
      % Memory Controller
      \node [inner sep=8pt, draw, below=30pt of Cache.center] (MC) {Memory
        Controller};%
      ...
      % arrows
      \draw [-latex] (Cache.south) -- ([yshift=5pt]MC.north);%
