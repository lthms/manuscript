...
subjective relation which allows for organizing a verification works into
several layers, \emph{e.g.} a functional specification can act as an
implementation of a more abstract functional specification.
%
