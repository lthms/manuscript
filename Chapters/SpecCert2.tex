...
to the \ac{bios} code injection sub-policy \( I_{\mathtt{bios}} \)
(Definition~\ref{def:speccert:biospol}) (\ref{subsec:speccert2:bioshsecorrect}).
...
requirement 3. ---the content of the SMRAM is owned by the \ac{bios}--- because
this requires to take the SMRR and the write-back strategy into account for the
\func{Write} and \func{Read}.
%
...
%
On the contrary, our \ac{hse} mechanism definition gathers six requirements over
hardware configurations and two requirements over software executions to enforce
a well-defined security property.
%
