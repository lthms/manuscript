...
model traces.
%
\GH{Je ne comprend pas trop cette phrase. Est-ce que tu fais un
  résumé de ce qui a été présenté avant (ce que suggère l'emplois du passé)?
  Dans ce cas, il faudrait la faire suivre pas une phrase indiquant ce que tu va
  présenter maintenant dans cette sous-section.}
