...
%
In practice, components of a larger system are often primarily identified by the
interface they expose to their pairs, that is the set of operation they can
carry out for the rest of the system.
%
