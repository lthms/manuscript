...
\texttt{SMRAMC} register. % TODO: rappel ref
%
Even if the content of the SMRAM was correctly protected by the memory
controller, the hardware architecture was not providing a trusted path for the
\ac{bios} to access this memory
region\,\cite{duflot2009smram,wojtczuk2009smram}.
...
Formally defining the targeted security policy.
