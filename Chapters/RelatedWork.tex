...
%
First, we introduce the key concepts of formal methods which support the formal
...
(Section~\ref{sec:sota:fm}).
%
We explain how transition systems are used as modeling structures to verify the
...
defining a specification (\ref{subsec:sota:compmod}), and dedicated verification
approaches, which enable ``divide and conquer'' strategies to reduce the burden
of verifying the system (\ref{subsec:sota:compverif}).
%
Related work~\ref{subsec:sota:comprelated}
%
TODO conclusion
