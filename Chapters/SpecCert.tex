...
\noindent
%
Our first contribution is a theory of \ac{hse} mechanisms, which
...
%
Our motivation to separate the model of the hardware architecture and
\ac{hse} mechanism definitions is to enable the reuse of the same hardware model
...
\begin{example}[Flash Memory Lockdown Inconsistency]
  ...
  a HSE mechanism which satisfies both laws, because the register ties together
