...
\TODO{et? Quel est le lien avec la suite? Il manque ici une transition, annoncant notamment le plan de la section.}
...
\TODO{Le titre est difficile à comprendre. }
...
%
Other examples showed blind trust in the context of foreign hardware components
...
\item [Volatile Memory Access Control]
  ...
  stack.
  %
  Besides, the \ac{bios} can rely on a \emph{secure channel} \thomasrk{ref?} to
...
than the system software component, including manipulating memories used by this
...
\end{itemize}
%
The most commonly used strategy is the write-back strategy, summarized in
Figure~\ref{fig:usecase:writeback}.
%
The purpose of the write-back strategy is to reduce the number of \IO forwarded
to the \ac{dram}.
%
