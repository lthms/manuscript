...
successors.
%
For instance, system software components (\emph{e.g.} an Operating System (OS) \GH{utiliser un  acronyme pour OS} or a
...
%
Concerning the lowest layers of a software stack \GH{du coup maintenant le terme n'a pas été défini}, the common approach is to rely
on features provided by the hardware architecture to reduce the hardware
capabilities that can be used by upper layers.
%
For instance, system software components \GH{system software n'a pas été défini} often leverage among other mechanisms a
...
complex.
%
In extreme scenarios, novel hardware features have been turned into attack vectors\,\cite{wojtczuk2011txtbug}.
%
...
have motivated our will to formally specify \GH{and verify?} HSE mechanisms.
%
...
hardware architecture. \GH{couper la phrase en deux. j'aime pas "to see"}
%
...
knowledge, the first formalization \GH{formalisation? anglais US ou GB?} of the \ac{bios} security model at runtime.
%
