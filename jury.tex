...
form of a list of requirements. Those requirements have to be satisfied by trusted software components in 
...
%%
% Unfortunately, defining a comprehensive model in terms of hardware and
% software components remains challenging, yet such a model is a prerequisite to
% verify HSE mechanisms.
