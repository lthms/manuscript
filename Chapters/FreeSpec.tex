...
to reason about a security policy which requires additional information.
%
For instance, if we want to determine how many times memory locations have been
updated since the beginning of the trace, we would have to modify the definitions
of \( H(S) \) and of the transition relation to add a counter along with the
owner of a memory location.
%
...
account the CPU cache, and to verify it complies with an abstract specification
