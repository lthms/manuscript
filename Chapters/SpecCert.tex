...
(first law), but the memory controller will protect its integrity in presence of
...
the cache, and nothing an untrusted software component to modify these copies.
%
...
A proof of correctness of a given \ac{hse} mechanism asserts that the hardware
...
instructions responsible to implement it.
%
...
of this thesis, we therefore did not investigated further the compatibility of
\ac{hse} mechanisms.
