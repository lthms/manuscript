...
%
A model checker would be able to exhibit a trace which corresponds to the SMRAM
cache poisoning attack.
%
We could also prove in a theorem prover that a given trace does not satisfies
$I_{\mathtt{bios}}$.
