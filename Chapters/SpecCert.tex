...
\begin{lemma}[Compliant Traces of Intersection]
  ...
  \begin{proof}
    ...
    of traces and \func{inv}, $R$ is the premise filtering software transitions, and
    $Q$ and $Q'$ are statements about \func{behaviour}.
  \end{proof}
\end{lemma}
...
%
SpecCert has been released as an free software\,\footnote{SpecCert can be found
  at the following URL: \url{https://github.com/lthms/speccert}}.
%
