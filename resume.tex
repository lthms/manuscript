...
\begin{otherlanguage}{french}
 ...
 Nous nous somme intéressés à ce second cas, et
  ...
  conséquence, la plus privilégiée~--- de la pile logicielle : le BIOS. \GH{j'ai rajouté explicitement le BIOS car sinon ta phrase était un peu vague. Par contre, il faudrait définir l'acronyme car c'est la première fois qu'il est utilisé il me semble. Je te laisse faire cela proprement.}
  ...
  propriétés qui s’appliquent dans l’absolu \GH{"inconditionnellement" me semble plus approprié que "dans l'absolu". Qu'en penses-tu? }à la plate-forme comme à la pile
  ...
  mémoire par un processeur (REF). \GH{il te manque deux ref à mettre ;-)}
  %
  ...
  avec le protokernel Pip (REF). \GH{reférence}
  %
  ...
  un sens particulier. \GH{redondance de "attacher". Je suggère "pour leur donner une sémantique particulière" plutôt que "pour permettre de leur attacher
  un sens particulier". Qu'en penses-tu?}
  %
  ...
  complexité inhérente aux architectures matérielles. \GH{Cette phrase n'est pas très claire. Peut-être que c'était le cas également de la version anglaise mais cela m'a échappé. On ne sait plus trop de quelle contribution tu parles (FreeSpec? SpecCert?)}
  %
  ...
  composants matériels sont fortement intégrés à la plate-forme matérielle et difficilement accessibles séparément. \GH{j'ai un peu reformulé ce passage. Est-ce que cela correspond à ce que tu voulais exprimer?}
  %
  ...
  le processeur et les périphériques les moins demandant en vitesse d’accès.
    %
  Ce dernier est maintenant directement intégré dans la fabrique du processeur d’Intel. \GH{je ne suis pas sur du sens de "fabrique" et de sa traduction française}
\end{otherlanguage}
