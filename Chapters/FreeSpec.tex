...
Using interfaces, we model how components interact with each others, and we aim
...
\begin{definition}[Program With Effects Realization]
...
% \GH{un petit exemple pour illustrer la précédente définition serait le
% bienvenu}
...
\begin{definition}[Deriving Operational Semantics]
...
For each incoming effect \( e \in \I \), we realize the program with effects
...
We do not detail its definition in this Chapter\,\footnote{Interesting readers
  ...
  require to understand the rest of this Chapter.}, but it has the significant
...
components, and is only used by one other component, \emph{e.g.} in
...
\begin{definition}[Predicate of Neutrality]
...
\begin{theorem}[Neutrality and Concurrency]
