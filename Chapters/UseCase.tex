...
%
That is, the system memory manipulated by the cores is no longer formed by the
\ac{dram} only.
%
...
out-of-band management features are not executed by the main processor: the ASF
...
%
Ring~3 imposes several restrictions to software components, including the
...
the need for cooperation from untrusted software components.
%
...
core, \emph{i.e.} implement preemptive multi-tasking.
