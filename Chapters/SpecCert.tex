...
%
Then, we give a formal definition of \ac{hse} mechanisms and \ac{hse} mechanisms
...
In practice, we identify a set of sets of software components and specify one
HSE mechanism per set.
...
\subsection{HSE Mechanisms Cooperation}
\label{subsec:speccert:coop}

\begin{definition}[HSE Mechanisms Intersection]
...
\begin{lemma}[Compliant Traces of Intersection]
  ...
  \begin{proof}
    ...
    of traces and \func{inv}, $R$ is the premice about software transitions, and $Q$ and $Q'$
    are statement about \func{behaviour}.
  \end{proof}
\end{lemma}
...
\begin{example}[Global Execution Policy Enforcement]
  ...
  %
  \[
    \Delta_{\mathtt{bios}} \sqcap \Delta_{\mathtt{os}} \models
    \func{safety\_property}_I
  \]
