...
\begin{example}[Airlock System Verification in Coq]
  The Coq theorem prover\,\cite{coq} includes two languages: a rich
  ...
  %
  We write the proof with {\sc Ltac}, and trust Coq to refuse it in case
  it is incorrect.
  %
  ...
  and the goal of a Coq user is to bring back this proof obligation to
