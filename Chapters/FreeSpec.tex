...
%
The \index{Coq} proof assistant\,\cite{coq} has proven to be effective to model
specific hardware
...
Reasoning about side effects in purely functional languages such as {\sc
  Gallina}, the \index{Coq} specification language, is difficult, firstly
...
\item We have implemented FreeSpec\,\footnote{FreeSpec has been released as a
    ...
    \url{https://github.com/ANSSI-FR/FreeSpec}}, a framework for the \index{Coq}
...
Modelling programs with side effects in purely functional languages such as {\sc
  Gallina} (the \index{Coq} specification language) or Haskell is usually
