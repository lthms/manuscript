...
%
By convenience, we give the same maximum address to each of \TODO{"of" n'est-il
  pas de trop?} address space.
...
The second law requires the state requirements to be invariant with respect to the
