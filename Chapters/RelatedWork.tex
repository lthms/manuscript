...
requirements over the rest of the system. \GH{Je ne comprends pas cette dernière
  phrase}
...
parallel.
%
It is a formal system to describe interacting systems \GH{répétition sur
  system}, together with a proof system for verifying them.
%
