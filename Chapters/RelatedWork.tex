...
%
\thomasrk[inline]{Pose toi, prends bien le temps de justifier. Tu veux dire que
  gérer un modèle complexe en modèle checking, même pour les théories les plus
  avancées, nécessite un travail de l’utilisateur et donc que ce n’est plus
